...
data_train = []
with open("WikiQACorpus/WikiQA-train.tsv") as tsvfile:
...
dmn = DMN(60)
for m in range(0,12):
	q_train,a_train,t_train = process_input(data_train)
	print len(q_train)
	...
	dmn.train(q_train,a_train,t_train)
