...
class DMN(object):
	def __init__(self,hidden_dim,vocab_size,batch_size = 20,bptt_truncate=-1,tm=7):
		...
		self.loss_gates = T.nnet.categorical_crossentropy(self.gates, sf)[0]/7.0
...
dmn.load_state('states/state.epoch24')
